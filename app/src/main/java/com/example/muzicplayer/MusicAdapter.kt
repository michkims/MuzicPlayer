...
import com.example.muzicplayer.MusicAdapter.MyHolder
import com.example.muzicplayer.databinding.DetailsViewBinding
import com.example.muzicplayer.databinding.MoreFeaturesBinding
import com.example.muzicplayer.databinding.MusicViewBinding
...
private val selectionActivity: Boolean = false)
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        Glide.with(context)
            ...
            .apply(RequestOptions().placeholder(R.drawable.ic_musical_round).centerCrop())
            .into(holder.image)
